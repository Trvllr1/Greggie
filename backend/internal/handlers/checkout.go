...
//
// Stacked on top of the base commission:
//   - Payment-fee markup: 0.5% of gross + $0.15 added on top of every
//     allocation to recoup the spread between what we charge sellers and
//     what Stripe charges us (2.9% + $0.30).
//
// (The CSP "new" 90-day honeymoon override was removed in migration 024
// when the CSP new rate was lowered from 20% to 15%.)
